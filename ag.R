...
df_log$arrecadacao_total <- ifelse(df$arrecadacao_total > 0, log(df$arrecadacao_total), 0)
...
df_log$receita_operacional_direta <- ifelse(df$receita_operacional_direta > 0, log(df$receita_operacional_direta), 0)
